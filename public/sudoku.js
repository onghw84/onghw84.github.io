...
let sudokuSolver0 = new SudokuSolver0();
genGame();
...
function genBoard(){	
	...
	if (level == 0){
		...
		while (i < 4){
			...
			if (!sudokuSolver0.checkRowPlacement(puzzle, row, column, value) && !sudokuSolver0.checkColPlacement(puzzle, row, column, value) && !sudokuSolver0.checkRegionPlacement(puzzle, row, column, value)){
				puzzle[index] = value;
				i += 1;			
			}
		}
		...
		while (i < 20){
			...
			if (!sudokuSolver.checkRowPlacement(puzzle, row, column, value) && !sudokuSolver.checkColPlacement(puzzle, row, column, value) && !sudokuSolver.checkRegionPlacement(puzzle, row, column, value)){
				puzzle[index] = value;
				i += 1;			
			}
		}
