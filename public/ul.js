...
switch (title){
	...
	case "Story":
		page = 18; disp = "Story"; break;				
	case "Rewards":
		page = 19; disp = "Rewards"; break;
	default:
		page = 1; disp = "Chinese FC"; break;
}
...
document.write(`
    ...
    <ul id="navbar">	  
	  ...
	  <li><a ${page == 18? 'class="active"':''} href="story.html">Story</a></li>
	  <li><a ${page == 19? 'class="active"':''} href="reward.html">Rewards</a></li>
    </ul>
`
);
